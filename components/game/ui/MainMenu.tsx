    ...
    return (
        <div className={`absolute inset-0 bg-black/80 backdrop-blur-xl flex flex-col items-center justify-center ${isMobile ? 'p-4' : 'p-8'} z-50 animate-in fade-in duration-500`}>
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <Button onClick={() => setGameState("achievements")} variant="outline" size="lg" className={`${isMobile ? 'h-16 px-12 text-2xl' : 'h-[90px] md:h-[110px] px-16 md:px-20 text-3xl md:text-4xl'} font-black rounded-[2.5rem] border-4 border-yellow-500/20 hover:border-yellow-500 hover:bg-yellow-500/10 text-white hover:scale-110 active:scale-95 transition-all uppercase tracking-[0.2em] w-full md:w-auto`}>
                    Achievements
                </Button>
            </div>
        </div>
