                                        ...
                                        <div className="relative">
                                            {s.level >= world.maxLevel && <Trophy className="w-8 h-8 text-yellow-500 drop-shadow-lg" />}
                                                                                            ...
                                                                                            <div className="flex flex-col">
                                                                                                ...
                                                                                                <span className="text-[10px] md:text-xs text-white/40 font-mono tracking-widest uppercase mt-1 italic">
                                                                                                    {world.name} • {formatDateTime(s.createdAt)} • {Math.floor(s.time / 60)}:{(s.time % 60).toFixed(0).padStart(2, '0')}
                                                                                                </span>
                                                                                            </div>                                    </div>
