...
export const darkForestTimeline: TimelineEvent[] = [
    ...
    { time: 5.5, enemyType: 'screecher', count: 4, message: "A piercing cry echoes through the trees!" },
    ...
    { time: 25, enemyType: 'bruiser', count: 2, message: "Something heavy approaches..." },
    ...
    { time: 60, enemyType: 'domovoi', count: 30, message: "A swarm of Domovoi appears!" },
    { time: 67.5, enemyType: 'screecher', count: 10 },
    { time: 75, enemyType: 'drifter', count: 30 },
    { time: 82.5, enemyType: 'tox_shroom', count: 8, message: "Poisonous spores fill the air!" },
    { time: 90, enemyType: 'bruiser', count: 5 },

    // --- Phase 2: Ramping Intensity (1:30 - 4:00) ---
    { time: 95, enemyType: 'forest_wraith', count: 1, isElite: true, message: "An ancient Wraith guards this path!" },
    { time: 100, enemyType: 'drifter', count: 35 },
    { time: 105, enemyType: 'domovoi', count: 40 },
    { time: 112.5, enemyType: 'screecher', count: 15 },
    { time: 120, enemyType: 'stone_golem', count: 3, message: "The earth trembles!" },
    { time: 127.5, enemyType: 'tox_shroom', count: 12 },
    { time: 135, enemyType: 'sapling', count: 30 },
    { time: 142.5, enemyType: 'drifter', count: 40 },
    { time: 150, enemyType: 'werewolf', count: 1, isElite: true, message: "The moon is high, and the hunt is on!" },
    ...
    { time: 225, enemyType: 'spirit_wolf', count: 8, message: "Ghostly howls surround you!" },
    { time: 240, enemyType: 'leshy_shaman', count: 3, message: "The forest's magic turns against you!" },
    ...
    { time: 270, enemyType: 'guardian_golem', count: 1, isBoss: true, message: "The Guardian of the Grove awakens!" },
    ...
    { time: 435, enemyType: 'ancient_treant', count: 1, isBoss: true, message: "The heart of the forest beats with rage!" },
    ...
    { time: 525, enemyType: 'wasp_swarm', count: 5, message: "The buzz of a thousand wings!" },
    { time: 540, enemyType: 'drifter', count: 70 },

    // --- Phase 5: The Unrelenting Swarm (9:00 - 12:30) ---
    { time: 550, enemyType: 'domovoi', count: 80 },
    { time: 560, enemyType: 'golem_destroyer', count: 1, isBoss: true, message: "A Destroyer arrives!" },
    ...
    { time: 675, enemyType: 'shadow_stalker', count: 6, message: "Shadows lengthen and twist..." },
    ...
    { time: 885, enemyType: 'chernobog', count: 1, isBoss: true, message: "The Lord of Darkness, Chernobog, has come for you!" },
