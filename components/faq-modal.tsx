                ...
                <div className="space-y-6 mt-4">
                    <section>
                        ...
                        <p className="text-muted-foreground">
                            You send a 1.23 BSV payment to the game development fund. In return, the system instantly mints a unique digital collectible item directly to your HandCash wallet.
                        </p>
                    </section>
